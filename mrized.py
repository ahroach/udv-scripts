...
def plot_amplitudes(elsasser = 1):
    ...
    scatter(mrized_data['speed']*2*pi/60, mrized_data['current']*2.8669, mrized_data['saturatedpower']*2000000/(mrized_data['speed']*mrized_data['speed']), label='_nolegend_')
    #also plot the xs.
